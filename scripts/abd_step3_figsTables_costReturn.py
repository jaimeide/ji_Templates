...
def main():
    """
    Generate plots and tables from df2plot (5min bins)
    """
    ...
    print('\n======================================================================================')
    print('=======    Generating {Cost,Return} x size plots and tables                 ==========')
    print('======================================================================================')
        ...
        for cHLG in allHLG:
            ...
            for HLG in cHLG:
                df2plot = df2plot.append(
                    pd.read_csv(os.path.join(dpath, 'df2plot_ABD_%s_%s_HLG%d.csv.gz' %(df2plotlabel,strat, HLG))))
                if HLG == cHLG[-1]:  # last
                    auxlabel += '%d' % HLG
                else:
                    auxlabel += '%d,' % HLG
            ...
            # except:
            #     print('** WARNING! ** Problem with HLG=%d:%s. Check...' % (HLG, ss))
